...
import pickle
from common.utils.utils import JointMapper, smpl_to_openpose

sto = smpl_to_openpose()
joint_mapper = JointMapper(sto)
...
class SMPL(object):
    def __init__(self):
        ...
        self.layer = {'neutral': smplx.create(cfg.human_model_path, 'smpl', gender='NEUTRAL', joint_mapper=joint_mapper,**self.layer_arg), 'male': smplx.create(cfg.human_model_path, 'smpl', gender='MALE', **self.layer_arg), 'female': smplx.create(cfg.human_model_path, 'smpl', gender='FEMALE', **self.layer_arg)}
