...
class Model(nn.Module):
    ...
    def get_camera_trans(self, cam_param):
        ...
        # print(k_value,"====zhegeshi k_value")
        # print(gamma,"========gamma")
        t_z = k_value * gamma
        cam_trans = torch.cat((t_xy, t_z[:, None]), 1)
        return cam_trans, gamma, k_value
    ...
    def forward(self, inputs, targets, meta_info, mode):
        ...
        cam_trans, gamma, k_value = self.get_camera_trans(cam_param)
        ...
        # final output
        joint_proj, joint_cam, mesh_cam, yuan_mesh = self.get_coord(root_pose, body_pose, lhand_pose, rhand_pose, jaw_pose, shape, expr, cam_trans, mode)
